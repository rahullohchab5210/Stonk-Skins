            ...
            <div className='max-w-287 mx-auto max-[1200px]:px-4 w-full '>
                <div className='flex flex-rowe items-center justify-between pb-4 pt-3 w-full '>
                    ...
                    <div className={`z-60 flex  flex-row max-lg:px-5 max-sm:px-10 lg:items-center  max-lg:flex-col max-lg:gap-4 gap-16 max-lg:flex-col  max-lg:pt-20 max-[1024px]:fixed max-[1024px]:bg-[#432755]    max-[1024px]:h-screen max-[1024px]:w-1/2 max-sm:w-full max-sm: max-[1024px]:top-0 max-[1024px]:transition-all max-[1024px]:duration-300 max-[1024px]:ease-linear ${menuOpen === "show" ? "max-[1024px]:right-0" : "max-[1024px]:-right-full"}`}>
                        <span onClick={() => setMenuOpen(null)} className='cursor-pointer font-medium text-[16px] leading-[125%] tracking-[0.6%] text-[#F5F5F5] font-dm w-fit'>Market</span>
                        <div>
                            <div className='flex lg:items-center  max-lg:flex-col max-lg:gap-4 gap-8'>
                                <div onClick={() => setMenuOpen(null)} className='cursor-pointer flex flex-row items-center gap-2 w-fit'>
                                    <Icons icon={'WALLET'} />
                                    <span className='text-[#F5F5F5] font-bold text-[16px] leading-[150%] tracking-[0%]'>$0</span>
                                </div>
                                <div className='flex items-center gap-1'>
                                    <div onClick={() => setMenuOpen(null)} className='cursor-pointer flex items-center gap-2 w-fit'>
                    ...
                    <div className="flex items-center  px-4 gap-[28px] w-full lg:hidden bg-[url('/assets/images/png/ellipse-three.png')] w-full max-w-[103px] h-[52px] bg-cover bg-center bg-no-repeat z-999">
                        <button aria-label="Search" onClick={() => setMenuOpen(false)} className="flex items-center   z-999 bg-[#FFFFFF0F]/6 rounded-[500px]">
                            <Icons icon={"SEARCH"} />
                        </button>
