...
function Footer() {
  return (
    <div className='  h-full w-full md:pt-[113px] sm:pt-[100px] pt-[70px]'>
      <div className='max-w-287 mx-auto  px-5'>
        <div className='flex lg:flex-row max-sm:gap-y-8 flex-col justify-between'>
          <div className='max-w-[310px]'>
            <a href="#"><img src="/assets/images/png/logo.png" alt="logo" className='max-w-39.25 max-h-18.5 w-full h-full' /></a>
      ...
      <div className='bg-[#FFFFFF0D] backdrop-blur-[10px] mt-10.25'>
